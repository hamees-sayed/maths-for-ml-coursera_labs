...
def test_f_of_omega(target_f_of_omega):
    ...
    for test_case in test_cases:
        result = target_f_of_omega(test_case["input"]["omega"], test_case["input"]["pA"], test_case["input"]["pB"])
...
def test_L_of_omega_array(target_L_of_omega_array):
    ...
    test_cases = [
        {
            "name": "default_check",
            "input": {"omega_array": np.linspace(0, 1, 1001, endpoint=True), "pA": prices_A, "pB": prices_B},
            "expected": {"shape": (1001,),
                         "L_of_omega_array": [
        ...
        {
            "name": "extra_check",
            "input": {"omega_array": np.linspace(0, 1, 11, endpoint=True), "pA": prices_A, "pB": prices_B},
            "expected": {"shape": (11,),
                         "L_of_omega_array": [
                             {"i": 0, "L_of_omega": 110.72,},
